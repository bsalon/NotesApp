...
class NotesAccordionItem(accordion.AccordionItem):
    def __init__(self, note, *args, **kwargs):
        super(NotesAccordionItem, self).__init__(background_normal="/home/benjaminsalon/diplom/NotesApp/Views/ColorE9F29B.png", background_selected="/home/benjaminsalon/diplom/NotesApp/Views/ColorD7EB5A.png", *args, **kwargs)
