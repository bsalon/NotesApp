...
class AdvancedFilterDialog(popup.Popup):
    def __init__(self, **kwargs):
        ...
        self.note_min_priority_input = textinput.TextInput(size_hint=(1/6, 1), multiline=False)
        note_priority_divider_label = label.Label(text="  -  ", color="black", size_hint=(1/6, 1))
        self.note_max_priority_input = textinput.TextInput(size_hint=(1/6, 1), multiline=False)
